...
import '../../css/resourceFormEdit.css'
...
function ResourceFormEdit() {
  ...
  const handleSubmit = async (e) => {
   ...
   try {
    ...
    ;
    console.log("Resource added:", response.data.message);
   } catch (error) {
  ...
  return (
    <div className="resource-container">
      <form className="resource-form" onSubmit={handleSubmit}>
        ...
        <h2>Edit Resource</h2>
        <p>Update the details of an existing resource</p>
        ...
        <div className="form-group">
          ...
          <textarea
            name="description"
            placeholder="Full-size football field with lights and seating"
       ...
       <div className="button-group">
        <button className="resource-button-cancel" type="button">
        Cancel
      </button>
